...
The question is whether we can make assumptions or use what we know about the economy to find the appropriate comparisons and so **recover** from the data the causal effect of brown hair on income.
...
This is effect size in the direction we expect and much closer to the 10% that we know is true. The difference between 12.2% and 10% is due to randomness.
...
By comparing means across conditions, we can observe whether difference in messaging led to (a) more users sharing, and (b) more recruitment of new donors:
