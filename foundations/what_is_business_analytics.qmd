...
That's no longer enough. Today's businesses operate in faster, more complex environments. Fortunately, they also have access to something that previous generations did not: **data**. From customer transactions to website clicks, social media posts to supply chain records, nearly every part of a business now generates data. A single online purchase creates dozens of data points: what the customer viewed, how long they hesitated, which payment method they chose, even how they arrived at the site. The challenge isn't collecting it—it's knowing what to do with it.
...
That story is ultimately what business analytics is trying to uncover. Analysts help businesses listen to what the data is saying—about customer needs, competitive dynamics, operational bottlenecks, or emerging opportunities—and translate that into actions.
...
> "At Netflix, every decision is backed by an experiment." — *Track down who*
...
5. **Acting to Create Value** — Ultimately, analytics only matters if it leads to better decisions. The goal is not analysis for its own sake, but to generate insights that drive strategy, improve operations, or better serve customers.
...
- How many website visitors came from paid ads?
...
- What sales should we expect in the holiday season?
...
- Does showing product reviews increase conversion rates?
...
Choosing the wrong tool for the question can lead to misleading conclusions. For example, a model that predicts which customers will churn is not the same as identifying **why** they churn—or what intervention would change that behavior.
...
2. "How would our customer satisfaction change if we reduced response times by 50%?"
   - Type: _______________

3. "Which customers are most likely to upgrade to our premium service?"
   - Type: _______________

4. "What was our employee turnover rate in Q3?"
   - Type: _______________

5. "Would offering free shipping increase our conversion rate?"
   - Type: _______________

6. "How many support tickets should we expect next week?"
   - Type: _______________
:::
...
## 1.8 Becoming a Business Analyst: The Interpreter Role
...
That story might be about why sales are falling, how a customer segment is evolving, or what might happen if the firm raises prices or changes strategy. But in every case, the analyst's role is the same: to build a bridge between the data and the decision.
...
These skills don't develop overnight. They grow through practice—through working on real problems, engaging with real data, and reflecting on how analysis shapes action.
...
## 1.9 How to Approach This Course (And Have Fun with It!)
