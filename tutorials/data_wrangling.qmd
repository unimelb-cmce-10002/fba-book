...
if(unprepared){
  firm_strategy <- 
    read_csv("data/firm_strategy.csv")
}
```
...
Your team has been asked to analyse how large Australian listed firms generate strong results, with a strong focus on differences across industries. As part of this project, you need to present an interim result to the executives overseeing the report.
