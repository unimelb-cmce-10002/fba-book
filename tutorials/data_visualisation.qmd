# Tutorial 3: Data Visualization for Business Analytics {.unnumbered}
...
### The Topic: Briefing the Sales Team at Ferg and Deer Property Advisory {.unnumbered}
...
1. **Where is market activity concentrated?** Which regions have the most listings? This could inform where the sales team should direct their focus.
2. **What do prices look like across property types?** How do Houses, Townhouses, and Units compare, and what does that imply about who can afford what?
3. **Does location explain the price differences?** How does proximity to the CBD affect property prices?
...
This is the finished one-pager you're building towards: one panel for each of the Head of Residential Sales's three questions, assembled into a single briefing.
